...
public final class Unsafe {
    ...
    public native void copyMemory(byte[] p0, long srcOffset, byte[] target, long targetIndex, long length) ;
     ...
     *
     * @param paramField non-{@code null}; the field in question, which must be an
     * instance field
    ...
    public native Object staticFieldBase(Field f);// { /* null implementation */ return null; }
    public native long staticFieldOffset(Field f);// { /* null implementation */ return 0; }
